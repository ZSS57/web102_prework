...
const unfundedGamesText = `There ${unfundedGamesCount === 1 ? 'is' : 'are'} ${unfundedGamesCount} unfunded ${unfundedGamesCount === 1 ? 'game' : 'games'} out of ${totalGamesCount} total games. We need your help to fund these amazing games!`;
